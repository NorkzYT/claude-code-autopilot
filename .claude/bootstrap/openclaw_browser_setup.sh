...
SE_BROWSER_ARGS_REMOTE_DEBUG_ADDR=--remote-debugging-address=0.0.0.0
SE_BROWSER_ARGS_REMOTE_DEBUG_PORT=--remote-debugging-port=${CDP_PORT}
SE_BROWSER_ARGS_NO_FIRST_RUN=--no-first-run
SE_BROWSER_ARGS_DISABLE_TRANSLATE=--disable-features=Translate
SE_BROWSER_ARGS_START_MAXIMIZED=--start-maximized
SE_BROWSER_ARGS_WINDOW_SIZE=--window-size=1920,1080
SE_BROWSER_ARGS_LOAD_EXTENSION=${ext_flags}
ENVEOF
